    ...
    <>
        <main className="flex flex-col items-center gap-8 w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl">
            ...
            <div className="w-full flex flex-col gap-4">
                ...
                <input onChange={(e) => setPassword(e.target.value)} type="password" placeholder="Senha" className="w-full p-3 border rounded" />
            </div>
            ...
            <Link href="/admin/user" className="text-cyan-500 text-center text-base mt-4">
